...
def plot_satellite_impact(results_file, results_path):
    ...
    plt.savefig(results_path / "Fig_B.2_dif_tt_is_satellite_change.png", dpi=400)
    plt.show()
...
def plot_band_impact(results_file, results_path):
    ...
    Saved to ``Fig_B.3_dif_tt_is_bands.png``.
    """
    ...
    plt.tight_layout()
    plt.grid(True, which="major", linestyle="--", linewidth=0.5)
    plt.savefig(results_path / "Fig_B.3_dif_tt_is_bands.png", dpi=400)
    plt.show()
